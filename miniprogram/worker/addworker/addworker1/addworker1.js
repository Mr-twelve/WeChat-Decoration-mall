...
Page({
  ...
  RegionChangebeiyun: function (e) {
    console.log(e)
    this.setData({
      regionbeiyun: e.detail.value
    })
  },
  formSubmit(e) {
    ...
    var sfzimgz = this.data.sfzimgz
    var sfzimgf = this.data.sfzimgf
    var region2 = this.data.regionbeiyun 
    const jibeng = {
      old: old,
      name: name,
